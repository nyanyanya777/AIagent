...
export default function TaskSelection({ onNext }: Props) {
  ...
  const handleNext = () => {
    setOnboarding({ ...onboarding, tasks: checked, completed: true });
    onNext();
  };
  return (
    <div style={{ display:"flex",alignItems:"center",justifyContent:"center",width:"100%",height:"100%",background:"var(--zinc-50)",overflow:"auto" }}>
      <div style={{ display:"flex",flexDirection:"column",alignItems:"center",width:520,gap:24,padding:"40px 0" }}>
        ...
        <button onClick={handleNext} style={{ display:"flex",alignItems:"center",justifyContent:"center",width:"100%",padding:"10px 16px",background:"var(--zinc-900)",color:"#fff",border:"none",borderRadius:6,cursor:"pointer",fontSize:14,fontWeight:500 }}>分析を開始</button>
